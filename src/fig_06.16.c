...
void mean(const unsigned int answer[]){
	...
	printf("The mean is the aveage value of the data\n"
		   "items. The mean is equal to the totoal of\n"
...
void median(unsigned int answer[]){
	...
	printf("\n\nThe median is element %u of\n"
		   ...
		   "For this this run the median is %u\n\n",
...
void bubbleSort(unsigned int a[]){
	...
	for(unsigned int pass = 1; pass < SIZE; ++pass){
		...
		// loop to control number f comparisons per pass
