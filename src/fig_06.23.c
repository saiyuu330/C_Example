...
int main(void){
	printf("%s", "Enter size of a one-dimesional array: ");
	...
	int array2D2[row2][col2]; // declare 2-D varialbe-length array
	...
	puts("\nSecond two-dimenstional array:");	
	print2DArray(row2, col2, array2D2); // pass other 2-D VLA function
}
